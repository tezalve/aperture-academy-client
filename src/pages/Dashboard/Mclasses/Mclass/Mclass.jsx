    ...
    return (
        <div className='col-3 p-2'>
            <div className="card align-items-center">
                ...
                <div className="card-body text-center border-right border-dark">
                    <a className={cls.status == "pending" ? "btn" : "btn disabled"} onClick={handleApprove}><FontAwesomeIcon className='fs-2 text-success' icon={faThumbsUp} /></a>
                </div>

                <div className="card-body text-center border-right border-dark">
                    <a className={cls.status == "pending" ? "btn" : "btn disabled"} onClick={handleDeny}><FontAwesomeIcon className='fs-2 text-danger' icon={faThumbsDown} /></a>
                </div>
